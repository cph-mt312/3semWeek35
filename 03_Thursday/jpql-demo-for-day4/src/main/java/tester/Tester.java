...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Query query1 = em.createQuery("Select e.salary FROM Employee e WHERE e.salary > 100000");
            List<Employee> result = query1.getResultList();
            System.out.println("Salaries over 100000: " + result);
            
            //2) Create a query to fetch the employee with the id "klo999" and print out the firstname
            
            Query query2 = em.createQuery("Select e.firstname FROM Employee e WHERE e.id = :id");
            ...
            System.out.println("First names of all employees: " + result4);
            ...
            System.out.println("Number of employees: " + result5.size());
